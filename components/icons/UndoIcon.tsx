...
/** An anticlockwise arrow: the notes chip's Undo (components/ExerciseNotesField.tsx).
 *  The mirror of ReuseIcon, same box, so the chip keeps its size as it flips. */
export default function UndoIcon({ size = 16, color = "#000" }: { size?: number; color?: string }) {
  return (
