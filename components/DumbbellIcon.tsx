// Canonical dumbbell SVG, shared by the tab bar, workout, new-program, and
// programs screens. The journal screen currently uses a near-identical local
// `WorkoutIcon` whose `d` path differs by a few control points — leaving it
// untouched preserves pixel-level parity. Unify after a pixel-diff confirms
// equivalence.
...
export default function DumbbellIcon({ size, color }: Props) {
  return (
